<div class="row g-4">
                ...
                <div class="listing-card__content-is">
                    ...
                    <div class="d-flex flex-wrap gap-4 align-items-center justify-content-between">
                        <div class="flex-grow-1">
                            <h4>
                                <a href="#" class="link clr-neutral-0 :clr-neutral-0"> Azha Ain Sokhna Resort </a>
                            </h4>
    ...
    <div class="col-xl-4 order-md-3 order-xl-2">
        <div class="row g-4">
                    ...
                    <div class="listing-card__content">
                        ...
                        <div class="listing-card__content-is">
                            ...
                            <div class="d-flex flex-wrap gap-4 gap-xl-0 align-items-center justify-content-between">
                                <div class="flex-grow-1">
                                    <h4>
                                        <a href="#" class="link clr-neutral-0 :clr-neutral-0 crop_text_1">Bloomfields
                                            Mostakbal City Compound</a>
                                    </h4>
                                    <div class="d-flex align-items-center gap-2">
                                        <span class="material-symbols-outlined mat-icon clr-tertiary-300"> distance </span>
                                        <span class="clr-neutral-0"> New Cairo </span>
            ...
            <div class="col-md-6 col-xl-12">
                <div class="listing-card">
                    <div class="listing-card__img promax_h">
                        <img src="./assets/imgs/pro2.jpg" alt="image" class="img-fluid w-100">
                    </div>
                    <div class="listing-card__content ">
                        <div class="d-flex align-items-center justify-content-end">
                            <a href="#" class="link d-inline-block py-2 px-5 rounded-pill
                        ...
                        <div class="listing-card__content-is">
                            ...
                            <div class="d-flex flex-wrap gap-4 gap-xl-0 align-items-center justify-content-between">
                                <div class="flex-grow-1">
                                    <h4>
                                        <a href="#" class="link clr-neutral-0 :clr-neutral-0 crop_text_1"> Sarai Compound New Cairo </a>
                                    </h4>
                                    <div class="d-flex align-items-center gap-2">
                                        <span class="material-symbols-outlined mat-icon clr-tertiary-300"> distance </span>
                                        <span class="clr-neutral-0"> New Cairo </span>
    ...
    <div class="col-md-6 col-xl-4 order-xl-3">
        <div class="listing-card">
            ...
            <div class="listing-card__content">
                <div class="d-flex align-items-center justify-content-between">
                    <a href="#" class="link d-inline-block py-2 px-5 rounded-pill bg-secondary-200 clr-neutral-900">
                        Completed </a>
                    <a href="#" class="link d-inline-block py-2 px-5 rounded-pill
                                            bg-tertiary-300 clr-neutral-900"> New </a>
                </div>
                <div class="listing-card__content-is">
                    ...
                    <div class="d-flex flex-wrap gap-4 align-items-center justify-content-between">
                        <div class="flex-grow-1">
                            <h4>
                                <a href="#" class="link clr-neutral-0 :clr-neutral-0 crop_text_1"> Mivida New Cairo
                                    Compound </a>
                            </h4>
                            <div class="d-flex align-items-center gap-2">
                                <span class="material-symbols-outlined mat-icon clr-tertiary-300"> distance </span>
